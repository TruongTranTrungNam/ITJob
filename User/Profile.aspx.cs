...
namespace ITJob.User
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        private void ShowUserProfile()
        {
            ...
            string query = "Select UserId,Username,Name,Address,Mobile,Email,City,Resume from [User] where Username=@username";
            ...
            {
                Response.Write("<script>alert('Đã thay đổi tài khoản, hãy đăng nhập lại..!');</script>");
            }
